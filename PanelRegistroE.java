...
public class PanelRegistroE extends JPanel {
    ...
    public void llenarTabla() {
        // Asegúrate de que this.gestionEmpleados no sea null antes de llamar a obtenerTodos()
        if (this.gestionEmpleados != null) {
            ...
            // model.setRowCount(0); // No necesitas reiniciar la tabla

            // Verificar si hay empleados antes de intentar llenar la tabla
            if (empleados != null) {
            ...
            // Manejar el caso donde gestionEmpleados es null
